...
// BTC implements a the Bitcoin difficulty adjustment algorithm, which is:
...
func NewBTC() *BTC {
	return &BTC{
		name:                   fmt.Sprintf("Bitcoin: Recalculate at every 2016 blocks using a 2016 block window"),
